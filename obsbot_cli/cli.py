...
# from obsbot_cli.commands.camera_controls import CameraControlCommands  # Changed from camera_controls.py
...
from obsbot_cli.commands.preview import PreviewCommands
from obsbot_cli.commands.camera_controls import CameraControlCommands  # Updated import
...
def main(device):
    ...
    # Initialize command handlers
    quick_setup = QuickSetupCommands(device)
    camera = CameraCommands(device)
    preview = PreviewCommands(device)
    camera_controls = CameraControlCommands(device)  # Using new refactored controller
    ...
    try:
        while True:
            ...
            if action == 'Exit':
                ...
                camera_controls.handle()  # Using the new refactored handler
